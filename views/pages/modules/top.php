...
<div class="col-12 col-sm-6 col-lg-3">
  ...
  <div class="small-box bg-info">
    ...
    <div class="inner">
      ...
      <p class="text-md">Dineros por Reservaciones</p>
...
<div class="col-12 col-sm-6 col-lg-3">
  ...
  <div class="small-box bg-primary">
    ...
    <div class="inner">
      ...
      <p class="text-md">Cantidad de Reservas</p>
...
<div class="col-12 col-sm-6 col-lg-3">
  ...
  <div class="small-box bg-dark">
    ...
    <div class="inner">
      ...
      <p class="text-md">Cantidad de Usuarios</p>
...
<div class="col-12 col-sm-6 col-lg-3">
  ...
  <div class="small-box bg-secondary">
    ...
    <div class="inner">
      ...
      <p class="text-md">Cantidad de Testimonios</p>
