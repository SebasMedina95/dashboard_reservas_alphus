...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="cargosModalLabel" aria-hidden="true" id="verContratoEmpleado">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-dark">
                ...
                <h5 class="modal-title text-white">Contrato de Empleado</h5>
