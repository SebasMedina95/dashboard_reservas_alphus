...
(9, 'Paseo sobre Nieve', 'views/img/planes/139.jpg', '<p>Paseo sobre nieve!, una experiencia fenomenal para aquellos que aman las aventuras sobre hielo; se incluye instructor si eres apenas un novato en este aspecto.</p>', 400000, 380000, '0', '2022-01-12 20:15:49'),
(10, 'Sobre el Cielo', 'views/img/planes/655.jpg', '<p>Plan maravillosa para estar sobre las nubes!, este maravilloso plan te invita a navegar por los paisajes mas preciosos de Noruega a bordo de un hermoso Globo Aerostático.</p>', 10000000, 5000000, '1', '2022-01-12 19:03:23'),
(11, 'Fiesta', 'views/img/planes/431.jpg', '<p>Plan de fiesta con tus amigos, incluye paseo por la ciudad los días de rumba así como la zona de discoteca del hotel exclusiva para aquellos que gozan de un gran ambiente musical y de licor. Promociones de bombones y barra libre para todos los gustos.</p>', 300000, 210000, '1', '2022-01-12 20:40:19');
